...
$webPush->sendNotification(
    ...
    $notifications[2]['payload'], // optional (defaults null)
    $notifications[2]['userPublicKey'], // optional (defaults null)
    $notifications[2]['userAuthToken'], // optional (defaults null)
